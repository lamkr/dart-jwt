...
void main() {
  const PRIVATE_KEY_FILE = "assets/rsa-private.pem";
  const PUBLIC_KEY_FILE = "assets/rsa-public.pem";
  const INVALID_PUBLIC_KEY_FILE = "assets/rsa-public_invalid.pem";
  ...
  test('shouldPassRSA256Verification', () {
    ...
    final secret = readPublicKeyFromFile(PUBLIC_KEY_FILE, "RSA") as RSAPublicKey;
